...
main(int argc, char *argv[]) {
  ...
  19:	81 ec 88 00 00 00    	sub    $0x88,%esp
    int x1 = getreadcount();
  1f:	e8 3f 03 00 00       	call   363 <getreadcount>
  24:	89 85 74 ff ff ff    	mov    %eax,-0x8c(%ebp)
    int rc = fork();
  2a:	e8 8c 02 00 00       	call   2bb <fork>
  ...
  3d:	56                   	push   %esi
  3e:	6a 04                	push   $0x4
  40:	e8 96 02 00 00       	call   2db <read>
    for (i = 0; i < 100000; i++) {
  ...
  4f:	7e 23                	jle    74 <main+0x74>
	(void) wait();
  51:	e8 75 02 00 00       	call   2cb <wait>
	int x2 = getreadcount();
  56:	e8 08 03 00 00       	call   363 <getreadcount>
	total += (x2 - x1);
	printf(1, "XV6_TEST_OUTPUT %d\n", total);
  5b:	52                   	push   %edx
	total += (x2 - x1);
  5c:	8b 95 74 ff ff ff    	mov    -0x8c(%ebp),%edx
  62:	29 d0                	sub    %edx,%eax
	printf(1, "XV6_TEST_OUTPUT %d\n", total);
  64:	50                   	push   %eax
  65:	68 18 07 00 00       	push   $0x718
  6a:	6a 01                	push   $0x1
  6c:	e8 9f 03 00 00       	call   410 <printf>
  71:	83 c4 10             	add    $0x10,%esp
    }
    exit();
  74:	e8 4a 02 00 00       	call   2c3 <exit>
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
  7f:	90                   	nop
