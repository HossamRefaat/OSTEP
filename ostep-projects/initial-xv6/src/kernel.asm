...
8010041f:	e8 ac 58 00 00       	call   80105cd0 <uartputc>
...
801004ea:	e8 e1 57 00 00       	call   80105cd0 <uartputc>
801004ef:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004f6:	e8 d5 57 00 00       	call   80105cd0 <uartputc>
801004fb:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100502:	e8 c9 57 00 00       	call   80105cd0 <uartputc>
...
80100b14:	0f 85 f1 00 00 00    	jne    80100c0b <exec+0x15b>
  ...
  if((pgdir = setupkvm()) == 0)
80100b1a:	e8 21 63 00 00       	call   80106e40 <setupkvm>
...
80100b8b:	e8 e0 60 00 00       	call   80106c70 <allocuvm>
...
80100bc1:	e8 da 5f 00 00       	call   80106ba0 <loaduvm>
...
80100c03:	e8 b8 61 00 00       	call   80106dc0 <freevm>
  if(ip){
...
80100cee:	e8 bd 63 00 00       	call   801070b0 <copyout>
...
80100d03:	e8 b8 60 00 00       	call   80106dc0 <freevm>
...
80100d5f:	e8 4c 63 00 00       	call   801070b0 <copyout>
...
80100dcb:	e8 40 5c 00 00       	call   80106a10 <switchuvm>
  freevm(oldpgdir);
80100dd0:	89 34 24             	mov    %esi,(%esp)
80100dd3:	e8 e8 5f 00 00       	call   80106dc0 <freevm>
  return 0;
...
80102ff2:	e8 09 29 00 00       	call   80105900 <idtinit>
...
80103013:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103016:	e8 e5 39 00 00       	call   80106a00 <switchkvm>
  seginit();
8010301b:	e8 50 39 00 00       	call   80106970 <seginit>
  lapicinit();
...
80103079:	e8 42 08 00 00       	call   801038c0 <pinit>
  tvinit();        // trap vectors
8010307e:	e8 fd 27 00 00       	call   80105880 <tvinit>
  binit();         // buffer cache
...
80103249:	68 b4 73 10 80       	push   $0x801073b4
...
8010337b:	68 b9 73 10 80       	push   $0x801073b9
...
801033a2:	68 af 73 10 80       	push   $0x801073af
...
801033d8:	68 1c 77 10 80       	push   $0x8010771c
...
80103480:	00 00 00 
  initlock(&p->lock, "pipe");
80103483:	68 d1 73 10 80       	push   $0x801073d1
...
80103814:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103817:	c7 40 14 72 58 10 80 	movl   $0x80105872,0x14(%eax)
  p->context = (struct context*)sp;
...
801038c6:	68 d6 73 10 80       	push   $0x801073d6
...
801039a3:	e8 98 34 00 00       	call   80106e40 <setupkvm>
...
801039c1:	e8 5a 31 00 00       	call   80106b20 <inituvm>
...
80103a2f:	68 06 74 10 80       	push   $0x80107406
80103a34:	50                   	push   %eax
80103a35:	e8 16 0e 00 00       	call   80104850 <safestrcpy>
  p->cwd = namei("/");
80103a3a:	c7 04 24 0f 74 10 80 	movl   $0x8010740f,(%esp)
...
80103a73:	68 ed 73 10 80       	push   $0x801073ed
...
80103aab:	e8 60 2f 00 00       	call   80106a10 <switchuvm>
  return 0;
...
80103aca:	e8 a1 31 00 00       	call   80106c70 <allocuvm>
...
80103aea:	e8 a1 32 00 00       	call   80106d90 <deallocuvm>
...
80103b38:	e8 f3 33 00 00       	call   80106f30 <copyuvm>
...
80103c60:	e8 ab 2d 00 00       	call   80106a10 <switchuvm>
...
80103c72:	e8 34 0c 00 00       	call   801048ab <swtch>
      switchkvm();
80103c77:	e8 84 2d 00 00       	call   80106a00 <switchkvm>
      c->proc = 0;
...
80103e7d:	68 5e 74 10 80       	push   $0x8010745e
80103e82:	e8 f9 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103e87:	83 ec 0c             	sub    $0xc,%esp
80103e8a:	68 51 74 10 80       	push   $0x80107451
...
80103f69:	e8 52 2e 00 00       	call   80106dc0 <freevm>
        p->pid = 0;
...
80103fc0:	68 6a 74 10 80       	push   $0x8010746a
...
801040c9:	68 70 74 10 80       	push   $0x80107470
801040ce:	e8 ad c2 ff ff       	call   80100380 <panic>
    panic("sleep");
801040d3:	83 ec 0c             	sub    $0xc,%esp
801040d6:	68 6a 74 10 80       	push   $0x8010746a
...
801041db:	68 2f 76 10 80       	push   $0x8010762f
...
801041fc:	74 ea                	je     801041e8 <procdump+0x28>
      state = "???";
801041fe:	ba 81 74 10 80       	mov    $0x80107481,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104203:	83 f8 05             	cmp    $0x5,%eax
80104206:	77 11                	ja     80104219 <procdump+0x59>
80104208:	8b 14 85 60 7a 10 80 	mov    -0x7fef85a0(,%eax,4),%edx
      state = "???";
8010420f:	b8 81 74 10 80       	mov    $0x80107481,%eax
...
8010421e:	68 85 74 10 80       	push   $0x80107485
...
8010425d:	68 c1 71 10 80       	push   $0x801071c1
...
8010428a:	68 b8 74 10 80       	push   $0x801074b8
...
801044e5:	68 c3 74 10 80       	push   $0x801074c3
801044ea:	e8 91 be ff ff       	call   80100380 <panic>
    panic("popcli");
801044ef:	83 ec 0c             	sub    $0xc,%esp
801044f2:	68 da 74 10 80       	push   $0x801074da
...
8010455b:	68 e1 74 10 80       	push   $0x801074e1
...
80104688:	68 e9 74 10 80       	push   $0x801074e9
...
80104aa7:	83 fa 15             	cmp    $0x15,%edx
80104aaa:	77 24                	ja     80104ad0 <syscall+0x40>
80104aac:	8b 14 85 80 7a 10 80 	mov    -0x7fef8580(,%eax,4),%edx
...
80104ad8:	68 f1 74 10 80       	push   $0x801074f1
...
80104c24:	68 29 75 10 80       	push   $0x80107529
...
80104c3c:	68 28 75 10 80       	push   $0x80107528
...
80104d15:	e8 36 fc ff ff       	call   80104950 <argint>
...
80104d40:	e8 0b fc ff ff       	call   80104950 <argint>
...
80104d55:	e8 46 fc ff ff       	call   801049a0 <argptr>
...
80104d6b:	e8 d0 c2 ff ff       	call   80101040 <fileread>
...
801052b7:	e8 44 f8 ff ff       	call   80104b00 <create>
    if(ip == 0){
...
8010535f:	e8 9c f7 ff ff       	call   80104b00 <create>
...
801053ee:	e8 0d f7 ff ff       	call   80104b00 <create>
     argint(2, &minor) < 0 ||
...
8010568f:	5d                   	pop    %ebp
80105690:	c3                   	ret
80105691:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80105698:	00 
80105699:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

801056a0 <sys_getreadcount>:
...
801056a0:	a1 58 3c 11 80       	mov    0x80113c58,%eax
801056a5:	c3                   	ret
...
801058ce:	00 00 ef 
  initlock(&tickslock, "time");
801058d1:	68 6e 75 10 80       	push   $0x8010756e
...
801058e4:	66 a3 c6 3e 11 80    	mov    %ax,0x80113ec6
  initlock(&tickslock, "time");
801058ea:	e8 c1 ea ff ff       	call   801043b0 <initlock>
}
801058ef:	83 c4 10             	add    $0x10,%esp
801058f2:	c9                   	leave
801058f3:	c3                   	ret
801058f4:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801058fb:	00 
...
80105942:	0f 84 58 01 00 00    	je     80105aa0 <trap+0x170>
    if(myproc()->killed)
      exit();
    return;
  }
...
8010594e:	0f 87 7c 00 00 00    	ja     801059d0 <trap+0xa0>
80105954:	ff 24 85 dc 7a 10 80 	jmp    *-0x7fef8524(,%eax,4)
8010595b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105960:	e8 cb c8 ff ff       	call   80102230 <ideintr>
    lapiceoi();
80105965:	e8 86 cf ff ff       	call   801028f0 <lapiceoi>
  }
...
8010596a:	e8 f1 df ff ff       	call   80103960 <myproc>
8010596f:	85 c0                	test   %eax,%eax
80105971:	74 1a                	je     8010598d <trap+0x5d>
80105973:	e8 e8 df ff ff       	call   80103960 <myproc>
80105978:	8b 50 24             	mov    0x24(%eax),%edx
8010597b:	85 d2                	test   %edx,%edx
8010597d:	74 0e                	je     8010598d <trap+0x5d>
8010597f:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105983:	f7 d0                	not    %eax
80105985:	a8 03                	test   $0x3,%al
80105987:	0f 84 db 01 00 00    	je     80105b68 <trap+0x238>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
8010598d:	e8 ce df ff ff       	call   80103960 <myproc>
80105992:	85 c0                	test   %eax,%eax
80105994:	74 0f                	je     801059a5 <trap+0x75>
80105996:	e8 c5 df ff ff       	call   80103960 <myproc>
8010599b:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
8010599f:	0f 84 ab 00 00 00    	je     80105a50 <trap+0x120>
...
801059ac:	74 1a                	je     801059c8 <trap+0x98>
801059ae:	e8 ad df ff ff       	call   80103960 <myproc>
801059b3:	8b 40 24             	mov    0x24(%eax),%eax
801059b6:	85 c0                	test   %eax,%eax
801059b8:	74 0e                	je     801059c8 <trap+0x98>
801059ba:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
801059be:	f7 d0                	not    %eax
801059c0:	a8 03                	test   $0x3,%al
801059c2:	0f 84 05 01 00 00    	je     80105acd <trap+0x19d>
    exit();
}
801059c8:	8d 65 f4             	lea    -0xc(%ebp),%esp
801059cb:	5b                   	pop    %ebx
801059cc:	5e                   	pop    %esi
801059cd:	5f                   	pop    %edi
801059ce:	5d                   	pop    %ebp
...
801059d0:	e8 8b df ff ff       	call   80103960 <myproc>
801059d5:	8b 7b 38             	mov    0x38(%ebx),%edi
801059d8:	85 c0                	test   %eax,%eax
801059da:	0f 84 a2 01 00 00    	je     80105b82 <trap+0x252>
801059e0:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
801059e4:	0f 84 98 01 00 00    	je     80105b82 <trap+0x252>
...
801059f0:	e8 4b df ff ff       	call   80103940 <cpuid>
...
80105a25:	68 bc 77 10 80       	push   $0x801077bc
80105a2a:	e8 81 ac ff ff       	call   801006b0 <cprintf>
    myproc()->killed = 1;
80105a2f:	83 c4 20             	add    $0x20,%esp
80105a32:	e8 29 df ff ff       	call   80103960 <myproc>
80105a37:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a3e:	e8 1d df ff ff       	call   80103960 <myproc>
80105a43:	85 c0                	test   %eax,%eax
80105a45:	0f 85 28 ff ff ff    	jne    80105973 <trap+0x43>
80105a4b:	e9 3d ff ff ff       	jmp    8010598d <trap+0x5d>
  if(myproc() && myproc()->state == RUNNING &&
80105a50:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105a54:	0f 85 4b ff ff ff    	jne    801059a5 <trap+0x75>
    yield();
80105a5a:	e8 71 e5 ff ff       	call   80103fd0 <yield>
80105a5f:	e9 41 ff ff ff       	jmp    801059a5 <trap+0x75>
...
80105a6f:	e8 cc de ff ff       	call   80103940 <cpuid>
80105a74:	57                   	push   %edi
80105a75:	56                   	push   %esi
80105a76:	50                   	push   %eax
80105a77:	68 64 77 10 80       	push   $0x80107764
80105a7c:	e8 2f ac ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105a81:	e8 6a ce ff ff       	call   801028f0 <lapiceoi>
    break;
80105a86:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a89:	e8 d2 de ff ff       	call   80103960 <myproc>
80105a8e:	85 c0                	test   %eax,%eax
80105a90:	0f 85 dd fe ff ff    	jne    80105973 <trap+0x43>
80105a96:	e9 f2 fe ff ff       	jmp    8010598d <trap+0x5d>
...
80105aaa:	0f 85 c8 00 00 00    	jne    80105b78 <trap+0x248>
    myproc()->tf = tf;
80105ab0:	e8 ab de ff ff       	call   80103960 <myproc>
80105ab5:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105ab8:	e8 d3 ef ff ff       	call   80104a90 <syscall>
    if(myproc()->killed)
80105abd:	e8 9e de ff ff       	call   80103960 <myproc>
80105ac2:	8b 48 24             	mov    0x24(%eax),%ecx
80105ac5:	85 c9                	test   %ecx,%ecx
80105ac7:	0f 84 fb fe ff ff    	je     801059c8 <trap+0x98>
}
...
80105ad3:	5d                   	pop    %ebp
      exit();
80105ad4:	e9 97 e2 ff ff       	jmp    80103d70 <exit>
80105ad9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105ae0:	e8 4b 02 00 00       	call   80105d30 <uartintr>
    lapiceoi();
80105ae5:	e8 06 ce ff ff       	call   801028f0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105aea:	e8 71 de ff ff       	call   80103960 <myproc>
80105aef:	85 c0                	test   %eax,%eax
80105af1:	0f 85 7c fe ff ff    	jne    80105973 <trap+0x43>
80105af7:	e9 91 fe ff ff       	jmp    8010598d <trap+0x5d>
80105afc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105b00:	e8 bb cc ff ff       	call   801027c0 <kbdintr>
    lapiceoi();
80105b05:	e8 e6 cd ff ff       	call   801028f0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b0a:	e8 51 de ff ff       	call   80103960 <myproc>
80105b0f:	85 c0                	test   %eax,%eax
80105b11:	0f 85 5c fe ff ff    	jne    80105973 <trap+0x43>
80105b17:	e9 71 fe ff ff       	jmp    8010598d <trap+0x5d>
80105b1c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105b20:	e8 1b de ff ff       	call   80103940 <cpuid>
80105b25:	85 c0                	test   %eax,%eax
80105b27:	0f 85 38 fe ff ff    	jne    80105965 <trap+0x35>
      acquire(&tickslock);
80105b2d:	83 ec 0c             	sub    $0xc,%esp
80105b30:	68 80 3c 11 80       	push   $0x80113c80
80105b35:	e8 66 ea ff ff       	call   801045a0 <acquire>
      ticks++;
80105b3a:	83 05 60 3c 11 80 01 	addl   $0x1,0x80113c60
      wakeup(&ticks);
80105b41:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
80105b48:	e8 93 e5 ff ff       	call   801040e0 <wakeup>
      release(&tickslock);
...
80105b59:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105b5c:	e9 04 fe ff ff       	jmp    80105965 <trap+0x35>
80105b61:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
80105b68:	e8 03 e2 ff ff       	call   80103d70 <exit>
80105b6d:	e9 1b fe ff ff       	jmp    8010598d <trap+0x5d>
80105b72:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105b78:	e8 f3 e1 ff ff       	call   80103d70 <exit>
80105b7d:	e9 2e ff ff ff       	jmp    80105ab0 <trap+0x180>
80105b82:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105b85:	e8 b6 dd ff ff       	call   80103940 <cpuid>
80105b8a:	83 ec 0c             	sub    $0xc,%esp
80105b8d:	56                   	push   %esi
80105b8e:	57                   	push   %edi
80105b8f:	50                   	push   %eax
80105b90:	ff 73 30             	push   0x30(%ebx)
80105b93:	68 88 77 10 80       	push   $0x80107788
80105b98:	e8 13 ab ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105b9d:	83 c4 14             	add    $0x14,%esp
80105ba0:	68 73 75 10 80       	push   $0x80107573
...
80105bd5:	c3                   	ret
80105bd6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80105bdd:	00 
...
80105c37:	0f 84 7c 00 00 00    	je     80105cb9 <uartinit+0xd9>
  uart = 1;
80105c3d:	c7 05 c0 44 11 80 01 	movl   $0x1,0x801144c0
80105c44:	00 00 00 
80105c47:	89 fa                	mov    %edi,%edx
80105c49:	ec                   	in     (%dx),%al
80105c4a:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105c4f:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80105c50:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105c53:	bf 78 75 10 80       	mov    $0x80107578,%edi
80105c58:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80105c5d:	6a 00                	push   $0x0
80105c5f:	6a 04                	push   $0x4
80105c61:	e8 fa c7 ff ff       	call   80102460 <ioapicenable>
80105c66:	83 c4 10             	add    $0x10,%esp
  for(p="xv6...\n"; *p; p++)
80105c69:	c6 45 e7 78          	movb   $0x78,-0x19(%ebp)
80105c6d:	8d 76 00             	lea    0x0(%esi),%esi
  if(!uart)
80105c70:	a1 c0 44 11 80       	mov    0x801144c0,%eax
80105c75:	85 c0                	test   %eax,%eax
80105c77:	74 32                	je     80105cab <uartinit+0xcb>
80105c79:	89 f2                	mov    %esi,%edx
80105c7b:	ec                   	in     (%dx),%al
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105c7c:	a8 20                	test   $0x20,%al
80105c7e:	75 21                	jne    80105ca1 <uartinit+0xc1>
80105c80:	bb 80 00 00 00       	mov    $0x80,%ebx
80105c85:	8d 76 00             	lea    0x0(%esi),%esi
    microdelay(10);
80105c88:	83 ec 0c             	sub    $0xc,%esp
80105c8b:	6a 0a                	push   $0xa
80105c8d:	e8 7e cc ff ff       	call   80102910 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105c92:	83 c4 10             	add    $0x10,%esp
80105c95:	83 eb 01             	sub    $0x1,%ebx
80105c98:	74 07                	je     80105ca1 <uartinit+0xc1>
80105c9a:	89 f2                	mov    %esi,%edx
80105c9c:	ec                   	in     (%dx),%al
80105c9d:	a8 20                	test   $0x20,%al
80105c9f:	74 e7                	je     80105c88 <uartinit+0xa8>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105ca1:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105ca6:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
80105caa:	ee                   	out    %al,(%dx)
  for(p="xv6...\n"; *p; p++)
80105cab:	0f b6 47 01          	movzbl 0x1(%edi),%eax
80105caf:	83 c7 01             	add    $0x1,%edi
80105cb2:	88 45 e7             	mov    %al,-0x19(%ebp)
80105cb5:	84 c0                	test   %al,%al
80105cb7:	75 b7                	jne    80105c70 <uartinit+0x90>
}
...
80105cd7:	74 4f                	je     80105d28 <uartputc+0x58>
{
80105cd9:	55                   	push   %ebp
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105cda:	ba fd 03 00 00       	mov    $0x3fd,%edx
...
80105ce6:	75 29                	jne    80105d11 <uartputc+0x41>
...
80105cfd:	e8 0e cc ff ff       	call   80102910 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105d02:	83 c4 10             	add    $0x10,%esp
80105d05:	83 eb 01             	sub    $0x1,%ebx
80105d08:	74 07                	je     80105d11 <uartputc+0x41>
80105d0a:	89 f2                	mov    %esi,%edx
80105d0c:	ec                   	in     (%dx),%al
80105d0d:	a8 20                	test   $0x20,%al
80105d0f:	74 e7                	je     80105cf8 <uartputc+0x28>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105d11:	8b 45 08             	mov    0x8(%ebp),%eax
80105d14:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105d19:	ee                   	out    %al,(%dx)
}
80105d1a:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105d1d:	5b                   	pop    %ebx
80105d1e:	5e                   	pop    %esi
80105d1f:	5d                   	pop    %ebp
80105d20:	c3                   	ret
...
80105d36:	68 b0 5b 10 80       	push   $0x80105bb0
80105d3b:	e8 60 ab ff ff       	call   801008a0 <consoleintr>
}
...
801067d5:	39 d3                	cmp    %edx,%ebx
801067d7:	73 56                	jae    8010682f <deallocuvm.part.0+0x6f>
801067d9:	89 4d e0             	mov    %ecx,-0x20(%ebp)
801067dc:	89 c6                	mov    %eax,%esi
801067de:	89 d7                	mov    %edx,%edi
801067e0:	eb 12                	jmp    801067f4 <deallocuvm.part.0+0x34>
801067e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
801067e8:	83 c2 01             	add    $0x1,%edx
801067eb:	89 d3                	mov    %edx,%ebx
801067ed:	c1 e3 16             	shl    $0x16,%ebx
  for(; a  < oldsz; a += PGSIZE){
801067f0:	39 fb                	cmp    %edi,%ebx
801067f2:	73 38                	jae    8010682c <deallocuvm.part.0+0x6c>
  pde = &pgdir[PDX(va)];
801067f4:	89 da                	mov    %ebx,%edx
801067f6:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
801067f9:	8b 04 96             	mov    (%esi,%edx,4),%eax
801067fc:	a8 01                	test   $0x1,%al
801067fe:	74 e8                	je     801067e8 <deallocuvm.part.0+0x28>
  return &pgtab[PTX(va)];
80106800:	89 d9                	mov    %ebx,%ecx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106802:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
80106807:	c1 e9 0a             	shr    $0xa,%ecx
8010680a:	81 e1 fc 0f 00 00    	and    $0xffc,%ecx
80106810:	8d 84 08 00 00 00 80 	lea    -0x80000000(%eax,%ecx,1),%eax
    if(!pte)
80106817:	85 c0                	test   %eax,%eax
80106819:	74 cd                	je     801067e8 <deallocuvm.part.0+0x28>
    else if((*pte & PTE_P) != 0){
8010681b:	8b 10                	mov    (%eax),%edx
8010681d:	f6 c2 01             	test   $0x1,%dl
80106820:	75 1e                	jne    80106840 <deallocuvm.part.0+0x80>
  for(; a  < oldsz; a += PGSIZE){
80106822:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106828:	39 fb                	cmp    %edi,%ebx
8010682a:	72 c8                	jb     801067f4 <deallocuvm.part.0+0x34>
8010682c:	8b 4d e0             	mov    -0x20(%ebp),%ecx
      kfree(v);
      *pte = 0;
    }
  }
...
8010682f:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
80106839:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      if(pa == 0)
80106840:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80106846:	74 26                	je     8010686e <deallocuvm.part.0+0xae>
      kfree(v);
80106848:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
8010684b:	81 c2 00 00 00 80    	add    $0x80000000,%edx
80106851:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106854:	81 c3 00 10 00 00    	add    $0x1000,%ebx
      kfree(v);
8010685a:	52                   	push   %edx
8010685b:	e8 40 bc ff ff       	call   801024a0 <kfree>
      *pte = 0;
80106860:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  for(; a  < oldsz; a += PGSIZE){
80106863:	83 c4 10             	add    $0x10,%esp
      *pte = 0;
80106866:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
8010686c:	eb 82                	jmp    801067f0 <deallocuvm.part.0+0x30>
        panic("kfree");
8010686e:	83 ec 0c             	sub    $0xc,%esp
80106871:	68 4c 73 10 80       	push   $0x8010734c
80106876:	e8 05 9b ff ff       	call   80100380 <panic>
...
80106891:	89 45 e0             	mov    %eax,-0x20(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106894:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
80106898:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010689d:	89 45 dc             	mov    %eax,-0x24(%ebp)
801068a0:	8b 45 08             	mov    0x8(%ebp),%eax
801068a3:	29 d8                	sub    %ebx,%eax
801068a5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801068a8:	eb 3f                	jmp    801068e9 <mappages+0x69>
801068aa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  return &pgtab[PTX(va)];
801068b0:	89 da                	mov    %ebx,%edx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801068b2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
801068b7:	c1 ea 0a             	shr    $0xa,%edx
801068ba:	81 e2 fc 0f 00 00    	and    $0xffc,%edx
801068c0:	8d 84 10 00 00 00 80 	lea    -0x80000000(%eax,%edx,1),%eax
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
801068c7:	85 c0                	test   %eax,%eax
801068c9:	74 75                	je     80106940 <mappages+0xc0>
    if(*pte & PTE_P)
801068cb:	f6 00 01             	testb  $0x1,(%eax)
801068ce:	0f 85 86 00 00 00    	jne    8010695a <mappages+0xda>
    *pte = pa | perm | PTE_P;
801068d4:	0b 75 0c             	or     0xc(%ebp),%esi
801068d7:	83 ce 01             	or     $0x1,%esi
801068da:	89 30                	mov    %esi,(%eax)
    if(a == last)
801068dc:	8b 45 dc             	mov    -0x24(%ebp),%eax
801068df:	39 c3                	cmp    %eax,%ebx
801068e1:	74 6d                	je     80106950 <mappages+0xd0>
    a += PGSIZE;
801068e3:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  for(;;){
801068e9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  pde = &pgdir[PDX(va)];
801068ec:	8b 4d e0             	mov    -0x20(%ebp),%ecx
801068ef:	8d 34 03             	lea    (%ebx,%eax,1),%esi
801068f2:	89 d8                	mov    %ebx,%eax
801068f4:	c1 e8 16             	shr    $0x16,%eax
801068f7:	8d 3c 81             	lea    (%ecx,%eax,4),%edi
  if(*pde & PTE_P){
801068fa:	8b 07                	mov    (%edi),%eax
801068fc:	a8 01                	test   $0x1,%al
801068fe:	75 b0                	jne    801068b0 <mappages+0x30>
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80106900:	e8 5b bd ff ff       	call   80102660 <kalloc>
80106905:	85 c0                	test   %eax,%eax
80106907:	74 37                	je     80106940 <mappages+0xc0>
    memset(pgtab, 0, PGSIZE);
80106909:	83 ec 04             	sub    $0x4,%esp
8010690c:	68 00 10 00 00       	push   $0x1000
80106911:	6a 00                	push   $0x0
80106913:	50                   	push   %eax
80106914:	89 45 d8             	mov    %eax,-0x28(%ebp)
80106917:	e8 84 dd ff ff       	call   801046a0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
8010691c:	8b 55 d8             	mov    -0x28(%ebp),%edx
  return &pgtab[PTX(va)];
8010691f:	83 c4 10             	add    $0x10,%esp
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106922:	8d 82 00 00 00 80    	lea    -0x80000000(%edx),%eax
80106928:	83 c8 07             	or     $0x7,%eax
8010692b:	89 07                	mov    %eax,(%edi)
  return &pgtab[PTX(va)];
8010692d:	89 d8                	mov    %ebx,%eax
8010692f:	c1 e8 0a             	shr    $0xa,%eax
80106932:	25 fc 0f 00 00       	and    $0xffc,%eax
80106937:	01 d0                	add    %edx,%eax
80106939:	eb 90                	jmp    801068cb <mappages+0x4b>
...
8010695d:	68 80 75 10 80       	push   $0x80107580
80106962:	e8 19 9a ff ff       	call   80100380 <panic>
80106967:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010696e:	00 
8010696f:	90                   	nop
...
80106973:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106976:	e8 c5 cf ff ff       	call   80103940 <cpuid>
  pd[0] = size-1;
...
8010698a:	c7 80 18 18 11 80 ff 	movl   $0xffff,-0x7feee7e8(%eax)
80106991:	ff 00 00 
80106994:	c7 80 1c 18 11 80 00 	movl   $0xcf9a00,-0x7feee7e4(%eax)
8010699b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010699e:	c7 80 20 18 11 80 ff 	movl   $0xffff,-0x7feee7e0(%eax)
801069a5:	ff 00 00 
801069a8:	c7 80 24 18 11 80 00 	movl   $0xcf9200,-0x7feee7dc(%eax)
801069af:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801069b2:	c7 80 28 18 11 80 ff 	movl   $0xffff,-0x7feee7d8(%eax)
801069b9:	ff 00 00 
801069bc:	c7 80 2c 18 11 80 00 	movl   $0xcffa00,-0x7feee7d4(%eax)
801069c3:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801069c6:	c7 80 30 18 11 80 ff 	movl   $0xffff,-0x7feee7d0(%eax)
801069cd:	ff 00 00 
801069d0:	c7 80 34 18 11 80 00 	movl   $0xcff200,-0x7feee7cc(%eax)
801069d7:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
801069da:	05 10 18 11 80       	add    $0x80111810,%eax
  pd[1] = (uint)p;
...
801069f0:	c9                   	leave
801069f1:	c3                   	ret
801069f2:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801069f9:	00 
801069fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80106a00 <switchkvm>:
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80106a00:	a1 c4 44 11 80       	mov    0x801144c4,%eax
...
80106a34:	0f 84 c2 00 00 00    	je     80106afc <switchuvm+0xec>
  pushcli();
80106a3a:	e8 11 da ff ff       	call   80104450 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106a3f:	e8 9c ce ff ff       	call   801038e0 <mycpu>
80106a44:	89 c3                	mov    %eax,%ebx
80106a46:	e8 95 ce ff ff       	call   801038e0 <mycpu>
80106a4b:	89 c7                	mov    %eax,%edi
80106a4d:	e8 8e ce ff ff       	call   801038e0 <mycpu>
80106a52:	83 c7 08             	add    $0x8,%edi
80106a55:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106a58:	e8 83 ce ff ff       	call   801038e0 <mycpu>
...
80106aa1:	e8 3a ce ff ff       	call   801038e0 <mycpu>
...
80106abf:	e8 1c ce ff ff       	call   801038e0 <mycpu>
80106ac4:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106ac7:	e8 14 ce ff ff       	call   801038e0 <mycpu>
80106acc:	66 89 78 6e          	mov    %di,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80106ad0:	b8 28 00 00 00       	mov    $0x28,%eax
80106ad5:	0f 00 d8             	ltr    %eax
...
80106b3b:	77 49                	ja     80106b86 <inituvm+0x66>
  mem = kalloc();
80106b3d:	e8 1e bb ff ff       	call   80102660 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106b4f:	e8 4c db ff ff       	call   801046a0 <memset>
...
80106b69:	e8 12 fd ff ff       	call   80106880 <mappages>
  memmove(mem, init, sz);
80106b6e:	83 c4 10             	add    $0x10,%esp
80106b71:	89 75 10             	mov    %esi,0x10(%ebp)
80106b74:	89 7d 0c             	mov    %edi,0xc(%ebp)
...
80106b80:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106b81:	e9 aa db ff ff       	jmp    80104730 <memmove>
    panic("inituvm: more than a page");
80106b86:	83 ec 0c             	sub    $0xc,%esp
80106b89:	68 c5 75 10 80       	push   $0x801075c5
80106b8e:	e8 ed 97 ff ff       	call   80100380 <panic>
80106b93:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106b9a:	00 
...
80106ba9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
80106bac:	8b 7d 18             	mov    0x18(%ebp),%edi
  if((uint) addr % PGSIZE != 0)
80106baf:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106bb5:	0f 85 a2 00 00 00    	jne    80106c5d <loaduvm+0xbd>
  for(i = 0; i < sz; i += PGSIZE){
80106bbb:	85 ff                	test   %edi,%edi
80106bbd:	74 7d                	je     80106c3c <loaduvm+0x9c>
80106bbf:	90                   	nop
  pde = &pgdir[PDX(va)];
80106bc0:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(*pde & PTE_P){
80106bc3:	8b 55 08             	mov    0x8(%ebp),%edx
80106bc6:	01 f0                	add    %esi,%eax
  pde = &pgdir[PDX(va)];
80106bc8:	89 c1                	mov    %eax,%ecx
80106bca:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
80106bcd:	8b 0c 8a             	mov    (%edx,%ecx,4),%ecx
80106bd0:	f6 c1 01             	test   $0x1,%cl
80106bd3:	75 13                	jne    80106be8 <loaduvm+0x48>
      panic("loaduvm: address should exist");
80106bd5:	83 ec 0c             	sub    $0xc,%esp
80106bd8:	68 df 75 10 80       	push   $0x801075df
80106bdd:	e8 9e 97 ff ff       	call   80100380 <panic>
80106be2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  return &pgtab[PTX(va)];
80106be8:	c1 e8 0a             	shr    $0xa,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106beb:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
80106bf1:	25 fc 0f 00 00       	and    $0xffc,%eax
80106bf6:	8d 8c 01 00 00 00 80 	lea    -0x80000000(%ecx,%eax,1),%ecx
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106bfd:	85 c9                	test   %ecx,%ecx
80106bff:	74 d4                	je     80106bd5 <loaduvm+0x35>
    if(sz - i < PGSIZE)
80106c01:	89 fb                	mov    %edi,%ebx
80106c03:	b8 00 10 00 00       	mov    $0x1000,%eax
80106c08:	29 f3                	sub    %esi,%ebx
80106c0a:	39 c3                	cmp    %eax,%ebx
80106c0c:	0f 47 d8             	cmova  %eax,%ebx
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106c0f:	53                   	push   %ebx
80106c10:	8b 45 14             	mov    0x14(%ebp),%eax
80106c13:	01 f0                	add    %esi,%eax
80106c15:	50                   	push   %eax
    pa = PTE_ADDR(*pte);
80106c16:	8b 01                	mov    (%ecx),%eax
80106c18:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106c1d:	05 00 00 00 80       	add    $0x80000000,%eax
80106c22:	50                   	push   %eax
80106c23:	ff 75 10             	push   0x10(%ebp)
80106c26:	e8 85 ae ff ff       	call   80101ab0 <readi>
80106c2b:	83 c4 10             	add    $0x10,%esp
80106c2e:	39 d8                	cmp    %ebx,%eax
80106c30:	75 1e                	jne    80106c50 <loaduvm+0xb0>
  for(i = 0; i < sz; i += PGSIZE){
80106c32:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106c38:	39 fe                	cmp    %edi,%esi
80106c3a:	72 84                	jb     80106bc0 <loaduvm+0x20>
}
80106c3c:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return 0;
80106c3f:	31 c0                	xor    %eax,%eax
}
80106c41:	5b                   	pop    %ebx
80106c42:	5e                   	pop    %esi
80106c43:	5f                   	pop    %edi
80106c44:	5d                   	pop    %ebp
80106c45:	c3                   	ret
80106c46:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106c4d:	00 
...
80106c60:	68 00 78 10 80       	push   $0x80107800
80106c65:	e8 16 97 ff ff       	call   80100380 <panic>
...
80106c7e:	0f 88 98 00 00 00    	js     80106d1c <allocuvm+0xac>
80106c84:	89 f2                	mov    %esi,%edx
  if(newsz < oldsz)
80106c86:	3b 75 0c             	cmp    0xc(%ebp),%esi
80106c89:	0f 82 a1 00 00 00    	jb     80106d30 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
80106c8f:	8b 45 0c             	mov    0xc(%ebp),%eax
80106c92:	05 ff 0f 00 00       	add    $0xfff,%eax
80106c97:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106c9c:	89 c7                	mov    %eax,%edi
  for(; a < newsz; a += PGSIZE){
80106c9e:	39 f0                	cmp    %esi,%eax
80106ca0:	0f 83 8d 00 00 00    	jae    80106d33 <allocuvm+0xc3>
80106ca6:	89 75 e4             	mov    %esi,-0x1c(%ebp)
80106ca9:	eb 44                	jmp    80106cef <allocuvm+0x7f>
80106cab:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    memset(mem, 0, PGSIZE);
80106cb0:	83 ec 04             	sub    $0x4,%esp
80106cb3:	68 00 10 00 00       	push   $0x1000
80106cb8:	6a 00                	push   $0x0
80106cba:	50                   	push   %eax
80106cbb:	e8 e0 d9 ff ff       	call   801046a0 <memset>
...
80106ccf:	89 fa                	mov    %edi,%edx
80106cd1:	50                   	push   %eax
80106cd2:	8b 45 08             	mov    0x8(%ebp),%eax
80106cd5:	e8 a6 fb ff ff       	call   80106880 <mappages>
80106cda:	83 c4 10             	add    $0x10,%esp
80106cdd:	85 c0                	test   %eax,%eax
80106cdf:	78 5f                	js     80106d40 <allocuvm+0xd0>
  for(; a < newsz; a += PGSIZE){
80106ce1:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106ce7:	39 f7                	cmp    %esi,%edi
80106ce9:	0f 83 89 00 00 00    	jae    80106d78 <allocuvm+0x108>
    mem = kalloc();
80106cef:	e8 6c b9 ff ff       	call   80102660 <kalloc>
...
80106cfd:	68 fd 75 10 80       	push   $0x801075fd
80106d02:	e8 a9 99 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
80106d07:	83 c4 10             	add    $0x10,%esp
80106d0a:	3b 75 0c             	cmp    0xc(%ebp),%esi
80106d0d:	74 0d                	je     80106d1c <allocuvm+0xac>
80106d0f:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106d12:	8b 45 08             	mov    0x8(%ebp),%eax
80106d15:	89 f2                	mov    %esi,%edx
80106d17:	e8 a4 fa ff ff       	call   801067c0 <deallocuvm.part.0>
    return 0;
80106d1c:	31 d2                	xor    %edx,%edx
}
80106d1e:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106d21:	89 d0                	mov    %edx,%eax
80106d23:	5b                   	pop    %ebx
80106d24:	5e                   	pop    %esi
80106d25:	5f                   	pop    %edi
80106d26:	5d                   	pop    %ebp
80106d27:	c3                   	ret
80106d28:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106d2f:	00 
    return oldsz;
80106d30:	8b 55 0c             	mov    0xc(%ebp),%edx
}
80106d33:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106d36:	89 d0                	mov    %edx,%eax
80106d38:	5b                   	pop    %ebx
80106d39:	5e                   	pop    %esi
80106d3a:	5f                   	pop    %edi
80106d3b:	5d                   	pop    %ebp
...
80106d43:	68 15 76 10 80       	push   $0x80107615
80106d48:	e8 63 99 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
80106d4d:	83 c4 10             	add    $0x10,%esp
80106d50:	3b 75 0c             	cmp    0xc(%ebp),%esi
80106d53:	74 0d                	je     80106d62 <allocuvm+0xf2>
80106d55:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106d58:	8b 45 08             	mov    0x8(%ebp),%eax
80106d5b:	89 f2                	mov    %esi,%edx
80106d5d:	e8 5e fa ff ff       	call   801067c0 <deallocuvm.part.0>
      kfree(mem);
80106d62:	83 ec 0c             	sub    $0xc,%esp
80106d65:	53                   	push   %ebx
80106d66:	e8 35 b7 ff ff       	call   801024a0 <kfree>
      return 0;
80106d6b:	83 c4 10             	add    $0x10,%esp
    return 0;
80106d6e:	31 d2                	xor    %edx,%edx
80106d70:	eb ac                	jmp    80106d1e <allocuvm+0xae>
80106d72:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80106d78:	8b 55 e4             	mov    -0x1c(%ebp),%edx
}
80106d7b:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106d7e:	5b                   	pop    %ebx
80106d7f:	5e                   	pop    %esi
...
80106d83:	5d                   	pop    %ebp
80106d84:	c3                   	ret
80106d85:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106d8c:	00 
...
80106da0:	5d                   	pop    %ebp
80106da1:	e9 1a fa ff ff       	jmp    801067c0 <deallocuvm.part.0>
...
80106db2:	5d                   	pop    %ebp
80106db3:	c3                   	ret
80106db4:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106dbb:	00 
...
80106ddb:	e8 e0 f9 ff ff       	call   801067c0 <deallocuvm.part.0>
...
80106e0e:	e8 8d b6 ff ff       	call   801024a0 <kfree>
...
80106e23:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106e24:	e9 77 b6 ff ff       	jmp    801024a0 <kfree>
    panic("freevm: no pgdir");
80106e29:	83 ec 0c             	sub    $0xc,%esp
80106e2c:	68 31 76 10 80       	push   $0x80107631
...
80106e45:	e8 16 b8 ff ff       	call   80102660 <kalloc>
80106e4a:	85 c0                	test   %eax,%eax
80106e4c:	74 5e                	je     80106eac <setupkvm+0x6c>
...
80106e60:	e8 3b d8 ff ff       	call   801046a0 <memset>
...
80106e73:	ff 73 0c             	push   0xc(%ebx)
80106e76:	50                   	push   %eax
80106e77:	29 c1                	sub    %eax,%ecx
80106e79:	89 f0                	mov    %esi,%eax
80106e7b:	e8 00 fa ff ff       	call   80106880 <mappages>
...
80106efc:	68 42 76 10 80       	push   $0x80107642
...
80106f43:	0f 84 e9 00 00 00    	je     80107032 <copyuvm+0x102>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80106f56:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106f5d:	00 
...
80106f72:	68 4c 76 10 80       	push   $0x8010764c
...
80106fd0:	e8 5b d7 ff ff       	call   80104730 <memmove>
...
80106feb:	e8 90 f8 ff ff       	call   80106880 <mappages>
...
80106ffd:	3b 75 0c             	cmp    0xc(%ebp),%esi
80107000:	0f 82 5a ff ff ff    	jb     80106f60 <copyuvm+0x30>
  return d;
...
8010701c:	e8 7f b4 ff ff       	call   801024a0 <kfree>
      goto bad;
...
80107047:	68 66 76 10 80       	push   $0x80107666
8010704c:	e8 2f 93 ff ff       	call   80100380 <panic>
80107051:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80107058:	00 
...
80107074:	0f 84 f8 00 00 00    	je     80107172 <uva2ka.cold>
  return &pgtab[PTX(va)];
...
80107084:	25 ff 03 00 00       	and    $0x3ff,%eax
  if((*pte & PTE_P) == 0)
80107089:	8b 94 82 00 00 00 80 	mov    -0x80000000(%edx,%eax,4),%edx
  return (char*)P2V(PTE_ADDR(*pte));
80107090:	89 d0                	mov    %edx,%eax
80107092:	f7 d2                	not    %edx
80107094:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107099:	05 00 00 00 80       	add    $0x80000000,%eax
8010709e:	83 e2 05             	and    $0x5,%edx
801070a1:	ba 00 00 00 00       	mov    $0x0,%edx
801070a6:	0f 45 c2             	cmovne %edx,%eax
}
801070a9:	c3                   	ret
...
801070c6:	e9 9d 00 00 00       	jmp    80107168 <copyout+0xb8>
801070cb:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
  return (char*)P2V(PTE_ADDR(*pte));
...
801070e2:	74 74                	je     80107158 <copyout+0xa8>
      return -1;
    n = PGSIZE - (va - va0);
801070e4:	89 fb                	mov    %edi,%ebx
801070e6:	29 c3                	sub    %eax,%ebx
801070e8:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
801070ee:	39 f3                	cmp    %esi,%ebx
801070f0:	0f 47 de             	cmova  %esi,%ebx
      n = len;
    memmove(pa0 + (va - va0), buf, n);
801070f3:	29 f8                	sub    %edi,%eax
801070f5:	83 ec 04             	sub    $0x4,%esp
801070f8:	01 c1                	add    %eax,%ecx
801070fa:	53                   	push   %ebx
801070fb:	52                   	push   %edx
801070fc:	89 55 10             	mov    %edx,0x10(%ebp)
801070ff:	51                   	push   %ecx
80107100:	e8 2b d6 ff ff       	call   80104730 <memmove>
    len -= n;
    buf += n;
...
80107115:	74 51                	je     80107168 <copyout+0xb8>
  if(*pde & PTE_P){
...
8010712d:	0f 84 46 00 00 00    	je     80107179 <copyout.cold>
  return &pgtab[PTX(va)];
...
8010714d:	f7 d1                	not    %ecx
8010714f:	83 e1 05             	and    $0x5,%ecx
80107152:	0f 84 78 ff ff ff    	je     801070d0 <copyout+0x20>
  }
  return 0;
}
...
80107172 <uva2ka.cold>:
  if((*pte & PTE_P) == 0)
80107172:	a1 00 00 00 00       	mov    0x0,%eax
80107177:	0f 0b                	ud2

80107179 <copyout.cold>:
80107179:	a1 00 00 00 00       	mov    0x0,%eax
8010717e:	0f 0b                	ud2
